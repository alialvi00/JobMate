...
url = "https://www.glassdoor.com/Job/ottawa-software-developer-jobs-SRCH_IL.0,6_IC2286068_KO7,25.htm?suggestCount=0&suggestChosen=false&clickSource=searchBtn&typedKeyword=software%2520developer"
...
for i in job_links:
  for a in i.find_all('a', href=True):
    joburl = ("http://glassdoor.com/" + a['href'])
