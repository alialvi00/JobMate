...
def runscript():
    ...
    for i in range(10) : 
        ...
        pdf.output("myapp/static/jobdesc_pdf/linkedin-desc-job-"+str(i)+".pdf", "F")
...
def createJson():
    ...
    directory = "myapp/static/jobdesc_pdf"
    for filename in os.listdir(directory):
        ...
        with open(filepath, "rb") as f:
            ...
            output_folder = "myapp/static/jobdesc_json"
...
def attach(i):
    with open("myapp/scrapers/jsonOutputs/resume_received.json", 'r') as g:
            data = json.load(g)

        # Load resume skills data 
    resume_skills = data["skills"]
    with open("myapp/static/jobdesc_json/linkedin-desc-job-"+str(i)+".pdf"+".json", 'r') as e:
