...
#Load the JSON data
with open("scrapers/jsonOutputs/linkedin_jobs.json", 'r') as f:
    data = json.load(f)
...
for i in range(10) : 
    ...
    pdf.output("static/jobdesc_pdf/linkedin-desc-job-"+str(i)+".pdf", "F")
...
with open("scrapers/jsonOutputs/resume_received.json", 'r') as g:
    data = json.load(g)
...
for filename in os.listdir(directory):
    ...
    with open(filepath, "rb") as f:
        ...
        output_folder = "scrapers/jsonOutputs"
...
for i in range(10):
    with open("scrapers/jsonOutputs/linkedin-desc-job-"+str(i)+".pdf"+".json", 'r') as e:
    ...
    print("The ratio similarity bewteen you resume and job description " + str(i) + " is : " + str(ratio)) 
    print("Those are the skills you are missing: ") 
    print(diff)